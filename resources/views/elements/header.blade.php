    ...
    <nav class="main-navigation">
        <ul class="nav-list">
            <li class="nav-list__item">
                <a href="{{route('main')}}" class="nav-list__item__link">Главная</a>
            </li>
            @auth
                <li class="nav-list__item">
                    <a href="{{route('cart')}}" class="nav-list__item__link">Мои заказы</a>
                </li>
            @endauth
            <li class="nav-list__item">
                <a href="{{route('news')}}" class="nav-list__item__link">Новости</a>
            </li>
            <li class="nav-list__item">
                <a href="{{route('about')}}" class="nav-list__item__link">О компании</a>
            </li>
        </ul>
    </nav>
